...
for k in range(len(tweet_tokens)):
    print(tweet_tokens[k])
...
# change castom_tweet to other string. and accurate this model.  ;-)
from nltk.tokenize import word_tokenize

custom_tweet = "we are so unhappy for buy it."
